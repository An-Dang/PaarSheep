...
public class SuchprofilAnzeigen extends VerticalPanel {
	...
	public SuchprofilAnzeigen() {
		...
		SuchprofilAnzeigenFlexTable.setText(0, 0, "Suchprofil-ID");
		SuchprofilAnzeigenFlexTable.setText(1, 0, "Suchprofilname");
		SuchprofilAnzeigenFlexTable.setText(2, 0, "Religion");
		SuchprofilAnzeigenFlexTable.setText(3, 0, "Körpergröße");
		SuchprofilAnzeigenFlexTable.setText(4, 0, "Haarfarbe");
		SuchprofilAnzeigenFlexTable.setText(5, 0, "Raucher");
...
//					.findSuchprofiByName( auswahlListBox.getSelectedItemText(), new AsyncCallback<Suchprofil>() {
//
//						public void onFailure(Throwable caught) {
//							infoLabel.setText("Es trat ein Fehler auf.");
//						}
...
//							
//							SuchprofilAnzeigenFlexTable.setText(0, 0, result.getSuchprofilName());
//							SuchprofilAnzeigenFlexTable.setText(1, 0, result.getReligion());
//							SuchprofilAnzeigenFlexTable.setText(2, 0, Integer.toString(result.getKoerpergroesse()));
//							SuchprofilAnzeigenFlexTable.setText(3, 0, result.getHaarfarbe());
//							SuchprofilAnzeigenFlexTable.setText(4, 0, result.getRaucher());
