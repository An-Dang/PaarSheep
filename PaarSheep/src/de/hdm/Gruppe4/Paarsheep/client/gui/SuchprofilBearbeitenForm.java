...
//		
//		
//		partnerboerseVerwaltung.updateSuchprofil( nutzerprofil.getProfilID(), suchprofilID, suchprofilname,  geschlecht,  raucher,
//				haarfarbe, religion, koerpergroesse, new AsyncCallback<Void>() {
//
//			@Override
